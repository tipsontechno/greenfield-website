...
import Image from "../../images/rb_55922.png";
...
const MainHeader = () => {
  ...
  useEffect(() => {
    if (language === "NL") {
      ...
      setparagraph(
        "Bij Greenfield Software beginnen we elke opdracht met een diepgaand gesprek om uw bedrijf, technologische uitdagingen en doelstellingen te begrijpen. Van daaruit ontwikkelen we een op maat gemaakte strategie die onze samenwerking begeleidt, succes garandeert en hoogwaardige softwareontwikkelingsdiensten levert."
      );
    } else {
      setinfo("Software Development Services");
      setparagraph(
        "At Greenfield Software, we begin every engagement with an in-depth discussion to understand your business, technology challenges, and goals. From there, we craft a tailored strategy that guides our collaboration, ensures success, and delivers top-tier software development services."
      );
    }
  }, [language]);
  return (
    <header className="main__header">
      <div className="container main__header-container text-[#e0e0e0]">
